...
<div class="container-fluid">
	<form action="" id="product-form">
		...
		<div class="form-group">
			...
			<input type="text" maxLength="50" name="code" id="code" class="form-control form-control-sm rounded-0" value="<?php echo isset($code) ? $code : ''; ?>"  required/>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="number" step="any" min="0.000009" name="price" id="price" class="form-control form-control-sm rounded-0 text-right" value="<?php echo isset($price) ? $price : ''; ?>"  required/>
		</div>
		<div class="form-group">
